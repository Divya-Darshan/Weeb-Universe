  ...
  return (
    <div className="relative z-50">
      ...
      <button
        ...
        className="p-2 text-gray-400 hover:text-white hover:bg-white/10 rounded-lg transition-all duration-200 flex items-center gap-1"
        title="Shopping cart"
      >
        <ShoppingBagIcon className="size-6" />
        <span className="sr-only">Open cart (3 items)</span>
      </button>
